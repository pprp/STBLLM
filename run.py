...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'low_quant_method',
        type=str,
        choices=['xnor', 'sign', 'no', '2bit',
                 '4bit', 'prune', 'braq', 'ternary'],
    ...
    parser.add_argument('--pbllm', action='store_true',
                        help='use pbllm or not')
    parser.add_argument('--billm', action='store_true',
                        help='use billm or not')
    ...
    parser.add_argument('--low_frac', type=float,
                        default=0.95, help='Target low_frac')
