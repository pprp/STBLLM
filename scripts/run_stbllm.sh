...
# 4:8
# MODEL_PATH="/path/to/hf-model/llama-3-8b"
...
CUDA_VISIBLE_DEVICES=0 python run.py /path/to/hf-model/Llama-2-7b-hf wikitext2 braq --blocksize 128 \
    --salient_metric hessian \
    --prune_method ria_structure \
    --reconstruction \
    --Lamda 2 \
    ...
    --sparsity_type 4:8
# 3:8
# CUDA_VISIBLE_DEVICES=7 python3 run.py /path/to/hf-model/llama-mistral-7b c4 braq --blocksize 128 \
#     --salient_metric hessian \
#     --prune_method ria_structure \
#     --reconstruction \
#     --Lamda 2 \
