...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=7 python3 run.py /data2/share/tinyllama/tinyllama-1.1b-480k-1t \
    ...
    --minlayer 1 \
    --maxlayer 19 \
    --quant_range 0 1000 > ./logs/sparsegpt_f_4_l_4_bs128_mn1_mx19.log 2>&1
...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=7 python3 run.py /data2/share/tinyllama/tinyllama-1.1b-480k-1t \
    ...
    --minlayer 2 \
    --maxlayer 18 \
    --quant_range 0 1000 > ./logs/wanda_f_4_l_4_bs128_mn2_mx18.log 2>&1
...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=7 python3 run.py /data2/share/tinyllama/tinyllama-1.1b-480k-1t \
    ...
    --minlayer 3 \
    --maxlayer 17 \
    --quant_range 0 1000 > ./logs/sparsegpt_f_4_l_4_bs128_mn3_mx17.log 2>&1
...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=7 python3 run.py /data2/share/tinyllama/tinyllama-1.1b-480k-1t \
    ...
    --minlayer 4 \
    --maxlayer 16 \
    --quant_range 0 1000 > ./logs/wanda_f_4_l_4_bs128_mn4_mx16.log 2>&1
...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=7 python3 run.py /data2/share/tinyllama/tinyllama-1.1b-480k-1t \
    ...
    --minlayer 5 \
    --maxlayer 15 \
    --quant_range 0 1000 > ./logs/sparsegpt_f_4_l_4_bs128_mn5_mx15.log 2>&1